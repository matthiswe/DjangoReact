...
import { FormHelperText, FormControl, Radio, RadioGroup, FormControlLabel, TextField, Button, Grid, Typography } from "@material-ui/core";
...
export default class CreateRoomPage extends Component{
    ...
    render() {
        ...
        <Grid container spacing={1}>
            ...
            <Grid item xs={12} align="center">
                <FormControl>
                    <TextField required={true} type="number" defaultvotes={this.defaultvotes} onChange={this.handleVotesChange} inputProps={{min:1, style:{textAlign:"center"}}}/>
                        <FormHelperText component={'div'}>
